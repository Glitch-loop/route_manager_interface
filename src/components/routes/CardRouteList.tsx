...
function CardRouteList({    
    ...
    <div className="w-full h-full flex flex-row mt-3">
        <div 
            ...
            >
            <span className="flex basis-1/6 justify-center text-black">{firstColumn}</span>
            <div className="flex flex-col basis-4/6 justify-center">
                <span className="text-black">{seconColumn}</span>
                <span className="text-sm text-black">{descriptionSecondColumn}</span>
            </div>
            <span className="flex basis-1/6 justify-center text-black">{thirdColumn}</span>
            <span className="flex basis-1/6 justify-center ml-1 text-black">{fourthColumn}</span>
        </div>
