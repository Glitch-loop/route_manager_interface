...
// Interfaces
import { SyncServerWorkdayInformationRepository } from '@/infrastructure/persitence/interface/server-database/SyncServerWorkdayInformationRepository';

// Models
import WorkDayInformationModel from '@/infrastructure/persitence/model/WorkdayInformationModel';
import UserModel from '@/infrastructure/persitence/model/UserModel';
